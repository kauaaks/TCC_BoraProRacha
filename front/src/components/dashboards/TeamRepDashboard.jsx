...
export default function TeamRepDashboard({ data }) {
  const { user } = useAuth()
  return (
    <div className="space-y-6 fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card><CardHeader><CardTitle>Pagamentos</CardTitle><CreditCard /></CardHeader><CardContent><div className="text-2xl font-bold">{data.payments.length}</div></CardContent></Card>
      </div>
