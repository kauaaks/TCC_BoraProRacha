caso não possua o node no pc, instale pelo site oficial: https://nodejs.org/pt?utm_source=chatgpt.com
...
npm start:all 
npm start:all vai instalar todos os node_modules, tanto de front com backend.
